...
import aboutImage from "@/assets/about-uwana.jpg";
import visionImage from "@/assets/vision-future.jpg";
import missionImage from "@/assets/mission-leadership.jpg";
            ...
            <section className="mb-16">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-first md:order-last">
                  <img 
                    src={aboutImage} 
                    alt="Young professionals in Akwa Ibom working together" 
            ...
            <section className="mb-16">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <img 
                    src={visionImage} 
                    alt="Bright future vision of Akwa Ibom youth" 
                    className="w-full h-auto rounded-lg shadow-lg"
                  />
                </div>
                <div>
