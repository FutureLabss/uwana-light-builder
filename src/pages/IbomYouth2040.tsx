...
import policyImage from "@/assets/policy-2040.jpg";
import documentaryImage from "@/assets/ndise-documentary.jpg";
            ...
            <section className="mb-16">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-first md:order-last">
                  <img 
                    src={policyImage} 
                    alt="Policy planning and economic development" 
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <img 
                    ...
                    alt="Ndise documentary production showcasing investment opportunities" 
                    className="w-full h-auto rounded-lg shadow-lg"
                  />
                </div>
                <div>
